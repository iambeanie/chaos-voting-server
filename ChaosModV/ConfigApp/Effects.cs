...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<EffectType, EffectInfo> EffectsMap = new Dictionary<EffectType, EffectInfo>()
        {
            ...
            {EffectType.EFFECT_DEATH_ROLL,  new EffectInfo("Death Roll", EffectCategory.MISC, "player_death_roll")},
            {EffectType.EFFECT_COOKIE_DOUGH,  new EffectInfo("Cookie Dough", EffectCategory.MISC, "misc_cookie_dough")},
            {EffectType.EFFECT_GET_UP,  new EffectInfo("Please get up", EffectCategory.MISC, "misc_get_up")},
            {EffectType.EFFECT_WORST_AVENGER,  new EffectInfo("Worst Avenger", EffectCategory.MISC, "misc_worst_avenger")},
            {EffectType.EFFECT_CONFLICTED_DRIVER,  new EffectInfo("Conflicted Driver", EffectCategory.MISC, "misc_conflicted_driver")},
            {EffectType.EFFECT_NOT_FAIR,  new EffectInfo("Quick to the slow", EffectCategory.MISC, "misc_not_fair")},
            {EffectType.EFFECT_HONK_HONK,  new EffectInfo("Honk make me fast", EffectCategory.MISC, "misc_honk_honk")},
            {EffectType.EFFECT_ROAD_BLENDER,  new EffectInfo("Road Blender", EffectCategory.MISC, "misc_road_blender")},
            {EffectType.EFFECT_NO_TRACTION,  new EffectInfo("Bit slippy today", EffectCategory.MISC, "misc_no_traction")},
            {EffectType.EFFECT_ADORING_FANS,  new EffectInfo("Adoring Fans", EffectCategory.MISC, "misc_adoring_fans")},
            {EffectType.EFFECT_CULLING,  new EffectInfo("The Culling", EffectCategory.MISC, "misc_culling")},
            {EffectType.EFFECT_FIERY_GAZE,  new EffectInfo("Fiery Gaze", EffectCategory.MISC, "misc_fiery_gaze")},
            {EffectType.EFFECT_PANIC,  new EffectInfo("Panic!!", EffectCategory.MISC, "misc_panic")},
            {EffectType.EFFECT_FIGHT_CLUB,  new EffectInfo("Fight Club", EffectCategory.MISC, "misc_fight_club")},
            {EffectType.EFFECT_DO_NOT_BELONG,  new EffectInfo("You do not belong here", EffectCategory.MISC, "misc_do_not_belong")},
            {EffectType.EFFECT_TWENTY_TWENTY,  new EffectInfo("The 2020 experience", EffectCategory.MISC, "misc_twenty_twenty")},
            {EffectType.EFFECT_MMM_MONKE,  new EffectInfo("mmmm Monke", EffectCategory.MISC, "misc_mmm_monke")},
            {EffectType.EFFECT_CLOWN_ATTACK, new EffectInfo("Clown Attack", EffectCategory.MISC, "misc_clown_attack", true, true)},
            {EffectType.EFFECT_MR_IMPORTANT, new EffectInfo("Mr Important", EffectCategory.MISC, "misc_mr_important", true, true)},
            {EffectType.EFFECT_RAIN_FIRE, new EffectInfo("Rain Fire", EffectCategory.MISC, "misc_rain_fire", true, true)},
            {EffectType.EFFECT_THE_MESSIAH, new EffectInfo("The Messiah", EffectCategory.MISC, "misc_the_messiah", true, true)},
            {EffectType.EFFECT_MOON_QUAKE, new EffectInfo("Moon Quake", EffectCategory.MISC, "misc_moon_quake", true, true)},
            {EffectType.EFFECT_TOOK_TOO_MUCH, new EffectInfo("Took too much", EffectCategory.MISC, "misc_took_too_much", true, true)},
            {EffectType.EFFECT_GOTTA_GO_FAST, new EffectInfo("Gotta go fast", EffectCategory.MISC, "misc_gotta_go_fast", true, true)},
            {EffectType.EFFECT_IS_IT_OVER_YET, new EffectInfo("Is it over yet", EffectCategory.MISC, "misc_is_it_over_yet", true, true)},
            {EffectType.EFFECT_ESCAPE, new EffectInfo("Escape", EffectCategory.MISC, "misc_escape", true, true)},
            {EffectType.EFFECT_MAYBE_ESCAPE, new EffectInfo("Maybe escape", EffectCategory.MISC, "misc_maybe_escape", true, true)},
            {EffectType.EFFECT_REALLY_BAD_NIGHT, new EffectInfo("Really bad night", EffectCategory.MISC, "misc_really_bad_night", true, true)},
            {EffectType.EFFECT_NO_ESCAPE, new EffectInfo("No escape", EffectCategory.MISC, "misc_no_escape", true, true)},
            {EffectType.EFFECT_NEED_A_RIDE, new EffectInfo("Need a ride", EffectCategory.MISC, "misc_need_a_ride", true, true)},
            {EffectType.EFFECT_BAD_COP_NO_DONUT, new EffectInfo("Bad cop no donut", EffectCategory.MISC, "misc_bad_cop_no_donut", true, true)},
            {EffectType.EFFECT_ICE_TO_MEET_YOU, new EffectInfo("Ice to meet you", EffectCategory.MISC, "misc_ice_to_meet_you", true, true)},
            {EffectType.EFFECT_JUNKER, new EffectInfo("Junker", EffectCategory.MISC, "misc_junker", true, true)},
            {EffectType.EFFECT_TOPSY_TURVY, new EffectInfo("Topsy Turvy", EffectCategory.MISC, "misc_topsy_turvy", true, true)},
            {EffectType.EFFECT_PLAGUE, new EffectInfo("Plague", EffectCategory.MISC, "misc_plague", true, true)},
            {EffectType.EFFECT_CHIPMUNKS, new EffectInfo("Chipmunks", EffectCategory.MISC, "misc_chipmunks", true, true)},
            {EffectType.EFFECT_WHERE_YOU_END_UP, new EffectInfo("Where you end up", EffectCategory.MISC, "misc_where_you_end_up", true, true)},
            {EffectType.EFFECT_MONEY_MAN, new EffectInfo("Money Man", EffectCategory.MISC, "misc_money_man", true, true)},
            {EffectType.EFFECT_FILTHY_CONSOLE_PEASANT, new EffectInfo("Filthy Console Peasant", EffectCategory.MISC, "misc_filthy_console_peasant", true, true)},
            {EffectType.EFFECT_NO_PEACE_AND_QUIET, new EffectInfo("No piece and quiet", EffectCategory.MISC, "misc_no_peace_and_quiet", true, true)},
            {EffectType.EFFECT_DRUGS_ARE_BAD, new EffectInfo("Drugs are bad", EffectCategory.MISC, "misc_drugs_are_bad", true, true)},
            {EffectType.EFFECT_WOLFMAN, new EffectInfo("Wolfman", EffectCategory.MISC, "misc_wolfman", true, true)},
            {EffectType.EFFECT_MARDI_GRAS, new EffectInfo("Mardi Gras", EffectCategory.MISC, "misc_mardi_gras", true, true)},
            {EffectType.EFFECT_BODIES_HIT_THE_FLOOR, new EffectInfo("Let the bodies hit the floor", EffectCategory.MISC, "misc_bodies_hit_the_floor", true, true)},
            {EffectType.EFFECT_EPIC_BENDER, new EffectInfo("Epic Bender", EffectCategory.MISC, "misc_epic_bender", true, true)},
            {EffectType.EFFECT_TOP_GUN, new EffectInfo("Top Gun", EffectCategory.MISC, "misc_top_gun", true, true)},
            {EffectType.EFFECT_BUMPER_CARS, new EffectInfo("Bumper Cars", EffectCategory.MISC, "misc_bumper_cars", true, true)},
            {EffectType.EFFECT_SANIC, new EffectInfo("Sanic", EffectCategory.MISC, "misc_sanic", true, true)},
            {EffectType.EFFECT_PEDS_SPAWN_SPACE_RANGER, new EffectInfo("Spawn Space Ranger", EffectCategory.PEDS, "peds_spawn_space_ranger")},
            {EffectType.EFFECT_THE_LEMONING, new EffectInfo("The Lemoning", EffectCategory.MISC, "misc_the_lemoning")},
        };
    }
}
