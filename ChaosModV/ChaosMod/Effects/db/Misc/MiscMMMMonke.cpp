...
static void OnStart()
{
	...
	for (int i = 0; i < 10; i++) {
		...
		GIVE_WEAPON_TO_PED(ped, GET_HASH_KEY("WEAPON_SWITCHBLADE"), 9999, false, true);
	}
}

static RegisterEffect registerEffect(EFFECT_MMM_MONKE, OnStart, nullptr, nullptr, EffectInfo
	{
		.Name = "mmmm Monke",
		.Id = "misc_mmm_monke"
	}
