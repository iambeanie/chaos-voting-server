...
static int maxClownsToSpawn = 30;
...
static void OnTick()
{
	...
	if (clownEnemies.size() < maxClownsToSpawn && current_time > spawnTimer + 250)
	{
...
static RegisterEffect registerEffect(EFFECT_CLOWN_ATTACK, OnStart, OnStop, OnTick, EffectInfo
	{
		.Name = "Clown Attack",
		.Id = "misc_clown_attack",
		.IsTimed = true,
