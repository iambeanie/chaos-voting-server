...
static void OnTickHonkBoosting()
{
	for (auto veh : GetAllVehs())
	{
...
static RegisterEffect registerEffect(EFFECT_WHERE_YOU_END_UP, OnStart, OnStop, OnTick, EffectInfo
	{
		.Name = "Where you end up",
		.Id = "misc_where_you_end_up",
		.IsTimed = true,
